...
#define JS_BT_SET_CONSTANT(name, constant) Nan::DefineOwnProperty(target, JS_STR( name ), \
	JS_INT(constant), constant_attributes)

#define JS_BT_CONSTANT(name) JS_BT_SET_CONSTANT(#name, name)
...
void init(Handle<Object> target) {
	...
	Body::Initialize(target);
	
	Nan::SetMethod(target, "Init", NodeBullet::Init);
